<template>
    <div>
        <div style="background:#eee;padding: 10px" v-for="item in sortxiaoliang" :key="item.id">
...
<script>
    ...
    computed:{
          sortxiaoliang:function(){
              return sortByXiaoliang(this.list,'xiaoliang')
          }
    },
    watch: {
 ...
 function sortByXiaoliang(array,key){
